...
/***/ "./src/pdf-embed/Modes/FullWindow.js":
/*!*******************************************!*\
  !*** ./src/pdf-embed/Modes/FullWindow.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _ViewSDKClient__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../ViewSDKClient */ "./src/pdf-embed/ViewSDKClient.js");
...
const FullWindow = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const viewSDKClient = new _ViewSDKClient__WEBPACK_IMPORTED_MODULE_1__["default"]();
    viewSDKClient.ready().then(() => {
      viewSDKClient.previewFile(`pebPDFArea_${clientId}`, {
        embedMode: 'FULL_WINDOW'
      }, attributes, pebAPIKey, globalViewerOptions);
    });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FullWindow);

/***/ }),

/***/ "./src/pdf-embed/Modes/InLine.js":
/*!***************************************!*\
  !*** ./src/pdf-embed/Modes/InLine.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/pdf-embed/Modes/Lightbox.js":
/*!*****************************************!*\
  !*** ./src/pdf-embed/Modes/Lightbox.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Lightbox = ({
  ...
  }, buttonText), isOpen && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/***/ "./src/pdf-embed/Modes/SizedContainer.js":
/*!***********************************************!*\
  !*** ./src/pdf-embed/Modes/SizedContainer.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const SizedContainer = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pebSizedContainer",
    id: `pebPDFArea_${clientId}`
  });
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SizedContainer);

/***/ }),

/***/ "./src/pdf-embed/PDFEmbed.js":
/*!***********************************!*\
  !*** ./src/pdf-embed/PDFEmbed.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Modes_SizedContainer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Modes/SizedContainer */ "./src/pdf-embed/Modes/SizedContainer.js");
/* harmony import */ var _Modes_InLine__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Modes/InLine */ "./src/pdf-embed/Modes/InLine.js");
/* harmony import */ var _Modes_FullWindow__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Modes/FullWindow */ "./src/pdf-embed/Modes/FullWindow.js");
/* harmony import */ var _Modes_Lightbox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Modes/Lightbox */ "./src/pdf-embed/Modes/Lightbox.js");
...
const PDFEmbed = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pebPDFEmbed"
  }, 'SIZED_CONTAINER' === config?.embedMode && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Modes_SizedContainer__WEBPACK_IMPORTED_MODULE_1__["default"], {
    attributes,
    clientId,
    pebAPIKey,
    globalViewerOptions
  }), 'IN_LINE' === config?.embedMode && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Modes_InLine__WEBPACK_IMPORTED_MODULE_2__["default"], {
    attributes,
    clientId,
    pebAPIKey,
    globalViewerOptions
  }), 'LIGHTBOX' === config?.embedMode && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Modes_Lightbox__WEBPACK_IMPORTED_MODULE_4__["default"], {
    attributes,
    clientId,
    pebAPIKey,
    globalViewerOptions
  }), 'FULL_WINDOW' === config?.embedMode && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Modes_FullWindow__WEBPACK_IMPORTED_MODULE_3__["default"], {
    attributes,
    clientId,
    pebAPIKey,
    globalViewerOptions
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PDFEmbed);

/***/ }),

/***/ "./src/pdf-embed/Style.js":
/*!********************************!*\
  !*** ./src/pdf-embed/Style.js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    dangerouslySetInnerHTML: {
      __html: `
			...
			${pdfEmbedSl}{
				...
				margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getSpaceCSS)(margin)};
...
/***/ "./src/pdf-embed/ViewSDKClient.js":
/*!****************************************!*\
  !*** ./src/pdf-embed/ViewSDKClient.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class ViewSDKClient {
  ...
  previewFile(divId, viewerConfig, attributes, pebAPIKey, passedGlobalOptions) {
    var _globalOpts$forceGlob, _globalOpts$showDownl, _ref, _options$showDownload, _globalOpts$showPrint, _ref2, _options$showPrintPDF, _globalOpts$showFullS, _ref3, _options$showFullScre;
    const {
      file,
      options = {}
    } = attributes;
    ...
    const forceGlobal = (_globalOpts$forceGlob = globalOpts.forceGlobal) !== null && _globalOpts$forceGlob !== void 0 ? _globalOpts$forceGlob : false;
    const showDownloadPDF = forceGlobal ? (_globalOpts$showDownl = globalOpts.showDownloadPDF) !== null && _globalOpts$showDownl !== void 0 ? _globalOpts$showDownl : false : (_ref = (_options$showDownload = options.showDownloadPDF) !== null && _options$showDownload !== void 0 ? _options$showDownload : globalOpts.showDownloadPDF) !== null && _ref !== void 0 ? _ref : false;
    const showPrintPDF = forceGlobal ? (_globalOpts$showPrint = globalOpts.showPrintPDF) !== null && _globalOpts$showPrint !== void 0 ? _globalOpts$showPrint : false : (_ref2 = (_options$showPrintPDF = options.showPrintPDF) !== null && _options$showPrintPDF !== void 0 ? _options$showPrintPDF : globalOpts.showPrintPDF) !== null && _ref2 !== void 0 ? _ref2 : false;
    const showFullScreen = forceGlobal ? (_globalOpts$showFullS = globalOpts.showFullScreen) !== null && _globalOpts$showFullS !== void 0 ? _globalOpts$showFullS : true : (_ref3 = (_options$showFullScre = options.showFullScreen) !== null && _options$showFullScre !== void 0 ? _options$showFullScre : globalOpts.showFullScreen) !== null && _ref3 !== void 0 ? _ref3 : true;
    const defaultConfig = {
      clientId: pebAPIKey
    };
    if (divId) {
    ...
    const previewFilePromise = this.adobeDCView.previewFile({
      ...
      metaData: {
        fileName: file.title || (file.url ? file.url.split('/').pop() : 'document.pdf'),
        id: file.id?.toString()
      }
    }, {
      showDownloadPDF,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ViewSDKClient);

/***/ }),

/***/ "./src/pdf-embed/style.scss":
/*!**********************************!*\
  !*** ./src/pdf-embed/style.scss ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!*******************************!*\
  !*** ./src/pdf-embed/view.js ***!
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/pdf-embed/style.scss");
/* harmony import */ var _Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Style */ "./src/pdf-embed/Style.js");
/* harmony import */ var _PDFEmbed__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./PDFEmbed */ "./src/pdf-embed/PDFEmbed.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  allPDFEmbed.forEach(pdfEmbed => {
    const {
      ...
      pebAPIKey,
      globalViewerOptions
    } = JSON.parse(pdfEmbed.dataset.props);
    const {
      cId,
      file
    } = attributes || {};
    const safeCId = cId ? cId.replace(/-/g, '_') : '';
    pebAPIKey && file?.url && (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(pdfEmbed).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      id: `pebPDFEmbed_${safeCId}`
    }, file?.url && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      attributes,
      clientId: safeCId
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_PDFEmbed__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes,
      clientId: safeCId,
      pebAPIKey,
      globalViewerOptions
